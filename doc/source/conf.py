...
# under the License.
#
# meteos documentation build configuration file, created by
...
project = u'meteos'
copyright = u'2010-present, Meteos contributors'

# The version info for the project you're documenting, acts as replacement for
# |version| and |release|, also used in various other places throughout the
# built documents.
#
from meteos.version import version_info
...
# [howto/manual]).
latex_documents = [
    ('index', 'Meteos.tex', u'Meteos Developer Documentation',
     u'Meteos contributors', 'manual'),
]
