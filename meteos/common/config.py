...
global_opts = [
    ...
    cfg.HostAddressOpt('scheduler_topic',
                       default='meteos-scheduler',
                       help='The topic scheduler nodes listen on.'),
    cfg.HostAddressOpt('learning_topic',
                       default='meteos-engine',
                       help='The topic learning nodes listen on.'),
    cfg.HostAddressOpt('data_topic',
                       default='meteos-data',
    ...
    cfg.IntOpt('sql_retry_interval',
               default=10,
               help='Interval between retries of opening a SQL '
                    'connection.'),
    cfg.HostAddressOpt('engine_manager',
    ...
    cfg.HostAddressOpt('storage_availability_zone',
                       default='nova',
                       help='Availability zone of this node.'),
    cfg.HostAddressOpt('default_learning_type',
                       help='Default learning type to use.'),
    cfg.ListOpt('memcached_servers',
                help='Memcached servers or None for in process cache.'),
    cfg.HostAddressOpt('learning_usage_audit_period',
                       default='month',
                       help='Time period to generate learning usages '
                            'for. Time period must be hour, day, month '
                            'or year.'),
    cfg.HostAddressOpt('root_helper',
                       default='sudo',
                       help='Deprecated: command to use for running '
                            'commands as root.'),
    cfg.HostAddressOpt('rootwrap_config',
    ...
    cfg.HostAddressOpt('learning_api_class',
                       default='meteos.engine.api.API',
                       help='The full class name of the learning API '
                            'class to use.'),
    cfg.HostAddressOpt('auth_strategy',
                       default='keystone',
